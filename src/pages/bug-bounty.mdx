...
<div style={{maxWidth: '650px', margin: '0px auto', padding: '0 1rem'}}>
<Title>Uniswap V3 Bug Bounty</Title>

<center>
  <Button  href="mailto:security@startcy.io">
    Submit a report
  </Button>
</center>
<br/>
...
Any vulnerability or bug discovered must be reported only to the following email: [security@startcy.io](mailto:contact@startcy.io).
...
- Be the first to disclose the unique vulnerability to security@startcy.io, in compliance with the disclosure requirements above. If similar vulnerabilities are reported within the same 24 hour period, rewards will be split at the discretion of Uniswap Labs.

- Provide sufficient information to enable our engineers to reproduce and fix the vulnerability.
- Not engage in any unlawful conduct when disclosing the bug to security@startcy.io, including through threats, demands, or any other coercive tactics.
